...
/*
  ...
  {
    0: {first_name: "hieu", last_name: "pham vaw", person_id: 1},
    1: {first_name: "Hieu", last_name: "", person_id: 2},
  }
...
*/
let _rowsFromSqlDataObject = (object) => {
  let data = {}
  let i = 0
  let j = 0
...
/*
  ...
  window.model.db.
*/
module.exports.initDb =  (appPath, callback) => {
